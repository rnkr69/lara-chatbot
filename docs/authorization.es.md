...
*[English](authorization.md) · Español*
...
> `TenantResolver`.
>
> Pre-lectura: §1 del [`getting-started.es.md`](getting-started.es.md) (instalación).
...
- [ ] Tests cubriendo: usuario sin permiso, usuario con permiso pero scope
      ...
      [`testing.es.md`](testing.es.md) para patrones.
...
- Doc del contrato `BackendTool`: [`backend-tools.es.md`](backend-tools.es.md).
